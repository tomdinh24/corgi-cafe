...
import { normalizePublicUrl, validatePublicLink } from "./publicLinks";
...
describe("member-provided public links", () => {
  ...
  it("validates LinkedIn and GitHub as profile links", () => {
    expect(
      validatePublicLink("linkedin_identifier", "https://example.com/in/casey").error,
    ...
    expect(
      validatePublicLink("linkedin_identifier", "https://github.com/casey").error,
    ).toBe("Add GitHub profile links in the GitHub field.");
  });
